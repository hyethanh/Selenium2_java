...
public class Constants {
    ...
    public static final String PAGE_TITLE_FORMAT = "TestArchitect ™ - %s";
    public static final int DEFAULT_PAGE_COLUMN = 2;
    public static final String DEFAULT_PANEL_STYLE = "2D";
